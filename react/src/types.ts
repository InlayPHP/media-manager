...
export type MediaEndpoints = {
  ...
  updateAsset?: string | null
  trashAsset?: string | null
  restoreAsset?: string | null
  deleteAsset?: string | null
  moveAsset?: string | null
  moveFolder?: string | null
  deleteFolder?: string | null
  syncAssetCollections?: string | null
...
export type MediaManagerProps = {
  ...
  renderPreview?: (asset: MediaAsset) => ReactNode
}

export type MediaPickerProps = Omit<MediaManagerProps, 'selectionMode' | 'onSelectionChange'> & {
  selectionMode?: MediaSelectionMode
  value?: MediaAsset[]
